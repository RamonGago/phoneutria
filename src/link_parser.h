...
int parse_page(int _sock, site_node_t **_site_queue, char *_host_name, char *_query);	/*parsing page to search query keyword and new urls*/
...
int spot_url(int _sock, site_node_t **_site_queue, FILE *page, char *_host_name);		/*search new urls to add in queue*/
